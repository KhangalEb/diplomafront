  ...
  return (
    ...
    >
      <div className="container my-24 px-6 mx-auto">
        <h2 className="mb-4 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white">Бидэнтэй холбогдох</h2>
                    ...
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                      <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                          ...
                          <p className="text-gray-500">99405740</p>
                        </div>
                      </div>
                    </div>
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
                      <div className="flex items-start">
                        ...
                        <div className="grow ml-6">
                          ...
                          <p className="text-gray-500">+976-99405740</p>
                        </div>
                      </div>
                    </div>
                    <div className="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 lg:w-full xl:w-6/12 px-3 md:px-6 xl:px-12">
